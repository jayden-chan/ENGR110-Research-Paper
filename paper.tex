...
\item
    Over time, information is collected by the sensor network. Again: the more data, the better the results. Typical metrics to measure are active occupancy hours, device usage patterns, energy usage rates, transportation patterns (this extends beyond the building itself but useful in many respects).
\item
